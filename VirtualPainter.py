...
brushThickness = 10
eraserThickness = 50
drawColor=(0,0,0)#setting black color
...
while True:
    ...
    if len(lmList)!=0:
        ...
        if fingers[1] and fingers[2]:
            ...
            if y1 < 125:
                if 250 < x1 < 450:#if i m clicking at blue brush
                    ...
                    drawColor = (23, 23, 255)
                elif 800 < x1 < 950:#if i m clicking at pink brush
                    header = overlayList[2]
                    drawColor = (255, 105, 194)
        ...
        if fingers[1] and fingers[2] == False:
            cv2.circle(img, (x1, y1), 7, drawColor, cv2.FILLED)#drawing mode is represented as circle
            #print("Drawing Mode")
